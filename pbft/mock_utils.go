...
func createTx(tag int64) (tx *types.Transaction) {
	txTime := &timestamp.Timestamp{Seconds: tag, Nanos: 0}
	tx = &types.Transaction{Type: types.Transaction_CHAINCODE_DEPLOY,
		Timestamp: txTime,
...
func marshalTx(tx *types.Transaction) (txPacked []byte) {
